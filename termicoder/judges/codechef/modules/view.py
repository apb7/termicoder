...
def problems(contest):
    ...
    for (sno, problem) in zip(range(len(problems)), problems):
        ...
        problem_data = contest_data['problems']
        pstats = contest_data['problemsstats']
        if(problem_data[problem['code']]['type'] not in normal_problem_types):
            name_style = style.challenge
        elif(problem['code'] in pstats['partially_solved']):
            name_style = style.partially_solved
        elif(problem['code'] in pstats['attempted']):
